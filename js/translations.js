...
const translations = {
  pt: {
    ...
    p2: "X-FUTUR3",
    p3: "EUR & AOA.",
    services: "<i class=\"fa-solid fa-wallet\" style='color: rgba(139,69,19,0.7)'></i> SERVIÇOS",
    team: "<i class=\"fa fa-user\" style=\"color:rgba(0,0,0,0.5)\"></i> EQUIPA",
    ...
    de: "De",
    para: "Para",
    update: "Conversão de <a href=\"#\">Euro/Dólar</a> para <a href=\"#\">Kwanza</a> — Última atualização 13 de abr. de 2025, 06:46 UTC",
    ...
    studentOrlean: "Estudante na Universidade de Reims Champagne-Ardenne, França.",
    ...
    studentLyonCIO: "Estudante na Universidade Claude Bernard Lyon 1, França.",
    ...
    reverseExchangeTryAgain: "Se não for isto, inverta o sentido da conversão e volte a tentar",
    confirm: "Confirmar",
    cancel: "Cancelar",
  ...
  en: {
    title: "Angoline",
    description: "Want to send money?<br>We offer a flexible exchange rate, tailored to your needs",
    descriptio: "Find here our agents",
    list : "Click here",
    p1: "Exchange",
    p2: "X-FUTUR3",
    p3: "EUR & AOA",
    services: "<i class=\"fa-solid fa-wallet\" style='color: rgba(139,69,19,0.7)'></i> SERVICES",
    team: "<i class=\"fa fa-user\" style=\"color: rgba(0,0,0,0.5)\"></i> TEAM",
    ...
    de: "From",
    para: "To",
    update: "Conversion from <a href=\"#\">Euro/Dollar</a> to <a href=\"#\">Kwanza</a> — Last updated April 13, 2025, 06:46 UTC",
    ...
    studentOrlean: "Student at the University of Reims Champagne-Ardenne, France.",
    ...
    studentLyonCIO: "Student at Claude Bernard Lyon 1 University, France.",
    ...
    reverseExchangeTryAgain: "If this is not correct, reverse the conversion direction and try again",
    confirm: "Confirm",
    cancel: "Cancel",
  ...
  fr: {
    title: "Angoline",
    description: "Vous souhaitez envoyer de l'argent?<br>Nous proposons un taux de change flexible, adapté à vos besoins",
    descriptio: "Trouvez ici nos agents",
    list : "Cliquez ici",
    p1: "Change",
    p2: "X-FUTUR3",
    p3: "EUR & AOA",
    services: "<i class=\"fa-solid fa-wallet\" style='color: rgba(139,69,19,0.7)'></i> SERVICES",
    team: "<i class=\"fa fa-user\" style=\"color:rgba(0,0,0,0.5)\"></i> ÉQUIPE",
    ...
    de: "De",
    para: "À",
    update: "Conversion de <a href=\"#\">Euro/Dollar</a> vers <a href=\"#\">Kwanza</a> — Dernière mise à jour 13 avr. 2025, 06:46 UTC",
    footer: "Créé par José Muxito",
    history: "Historique des taux de change",
    ...
    studentOrlean: "Étudiant à l'Université de Reims Champagne-Ardenne, France.",
    ...
    studentLyonCIO: "Étudiant à l'Université Claude Bernard Lyon 1, France.",
    ...
    reverseExchangeTryAgain: "Si ce n'est pas correct, inversez le sens de la conversion et réessayez",
    confirm: "Confirmer",
    cancel: "Annuler",
